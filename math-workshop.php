...
<title>Maths Tuition in Gurgaon Sector 52 , Ardee city | MyLearningPlanet</title>
<meta name="description" content="MyLearningPlanet is a Maths tuition, Mathematics Classes  or Special Maths tuition for Children in gurgaon sector 52 Ardee city . call me at 0124-438-2633.">
<meta name="Keywords" content="maths tuition in gurgaon, maths tuition in gurgaon sector 52, Special Maths tuition in gurgaon, Special Maths Teacher in gurgaon, Class I To VIII Math Tuition in Gurgaon, Special Mathematics Classes for Class I to VIII">
...
<p class="mail">
                                            	...
                                            	<ul>
                                                	<li class="widget widget_recent_entries">
                                                    	<div class="entry-thumb">
                                                        	<a href="fun-evenings.php"><img src="images/mega_menu_blog_img1.jpg" alt="" width="200" height="137" title="Fun and evenings"></a><a href="fun-evenings.php" class="funt">Fun evenings</a>
                                                        </div>
        ...
        <div id="main">
            ...
            <div class="breadcrumb-section">
            	<div class="container">
                	<h1>Special Maths Tuition in Gurgaon</h1>
                    <div class="breadcrumb">
                        <a href="index.php">Home</a>
                        <span class="fa fa-angle-double-right"></span>
                        <a href="#">Services</a>
                        <span class="fa fa-angle-double-right"></span>
                        <span class="current">Math’s workshops </span>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
            	...
            	<section id="primary" class="content-full-width">
                            ...
                            <div class="dt-sc-pr-tb-col mustard">	
                                <div class="dt-sc-tb-header">
                                    <div class="dt-sc-tb-thumb">
                                        <img src="images/pricing-image3.jpg" width="572" height="350" alt="Pricing Details" title="">
                                    </div>
                    ...
                    <div class="column dt-sc-one-half">                  
                        ...
                        <p style="text-align: justify">Mathematics is an indispensable subject of study. It plays an important role in forming the basis of all other sciences which deal with the material substance of space and time. Mathematics may be described as the fundamental science. It may be broadly described as the science of space, time and numbers. </p>
						<p style="text-align: justify">Mathematics has a most important bearing on the intellect as such. Study of Mathematics promotes habits of accuracy and exactitude, and prevents a man from being careless and slipshod. We at learning planet provides <b><a rel="nofollow" href="http://www.mylearningplanet.in/tutions.php">special mathematics classes</a></b> to the students which help in sharpening their reasoning powers and enhances their mental alertness also.</p><p>From time to time we conduct logical workshops also which is a method of delivering math instruction. These workshops provide students with repeated experience with the concepts being learned and time to practice important skills and refine strategies.</p>
                        <p style="text-align: justify">Math Workshop provides students the time and opportunity to revisit important math ideas that they are learning in whole group activities and discussions; develop a deeper understanding of these concepts through repeated experience, in different contexts; refine their strategies for solving problems; and practice important skills.</p>
						
						</div> 
                     <div class="entry-body" style="margin-top:10px; float:left; width:100%;">
                   <p style="text-align: justify">During Math Workshop students are expected to choose which activities to work on, plan their time so they can complete more than one activity, keep track of their work, and use and take care of classroom materials.</p>
                       <p style="text-align: justify">They are also expected to work independently, in pairs, or in a small group and to follow the classroom norms for working successfully in all of these groupings.</p></div>
