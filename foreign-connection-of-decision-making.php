...
<title>My Learning Planet - Foreign connection of Decision Making</title>
...
<ul class="nav navbar-nav">
        ...
        <div id="main">
            ...
            <div class="breadcrumb-section">
            	<div class="container">
                	<h1>Foreign connection of Decision Making</h1>
            	...
            	<section id="primary" class="with-sidebar">
                    ...
                    <article class="blog-entry">
                        <div class="blog-entry-inner">
                            ...
                            <div class="entry-thumb">
                                <a href="#"><img src="images/Foreign connection of Decision Making.jpg" alt="Foreign connection" title=""></a>
                            </div>		
                            <div class="entry-details">	
                                <div class="entry-title">
                                    <h3>Foreign connection of Decision Making</h3>
                                </div>			
                                <!--entry-metadata ends-->	
                                <div class="entry-body">
									<p class="s_j">The paybacks of learning a foreign language are well known and well-documented.  It changes neuron connections of the brain, develops memory, and stops dementia.  But psychologists and language experts have found one uncharacteristic thing, learning an additional language does to us, it makes us take more risk.  </p>
									<p class="s_j">It has been found that thinking and speaking in a foreign language alters our way of making decisions. In an experiment conducted, participants were asked to play 20 rounds and were given $20 for. In each round, the participators had choice of either abstaining or risking the money by putting $1 on the table and to bet heads or tails. The participants risk losing the dollar if they place the dollar on the table but the prize of winning is $2.50 for each head. In this experimentation, there is a positive expected value—the chances of making money are more because the probability is 50% thus the chances of participants losing money is 50% for every flip but you are able to win is $2.50 with every flip. Thus, the return is more than 50%.</p>
									<p class="s_j">Rationally, one would presume the partakers to bet the $1 each time as there is positive expected value. But that was not what happened. It was found that when the instructions were given in English, students displayed reserved behaviour in their betting and opted to keep the $1 instead of betting it. However, when the commands were given in a foreign language (Spanish), the participators were more willing to take risks by 20% of the time.</p>
                                     <p class="s_j">The experiment conjointly tested spatiality in decision-making that happens once the selection is framed as either a win or a loss. In general, the participants were a lot of risk adverse once the question is framed as a gain. However once a selection is framed as a loss, participants were willing to require a lot of risks.</p>
									<p class="s_j">However, this spatiality is gone once the selection is framed in a very foreign language. The participants had constant level of risk whether or not the question was framed as a loss or a gain. The participants were ready to mostly ignore the approach the question is framed and evaluated the selection supported first moment. Therefore, the participants selected to risk the $1 whenever due to the positive first moment.</p>
									<p class="s_j">Other experiments have confirmed constant sort of risk aversion seen during this study. Students were willing to require a lot of calculated risks once speaking/listening to a remote language.</p>
									<p class="s_j">What’s the rationale for the danger aversion once speaking in our mother language and also the increased risk-taking once speaking in another language? Research worker suppose this is often as a result of theirs bigger psychological feature and emotional distancing once speaking, listening, and reading in a very foreign language—the words in a very foreign language don't equate to constant emotional which means as they are doing in our mother language. Therefore this bigger emotional distancing in a very foreign language may be a smart factor because it will offer us the power to form a lot of economically rational choices.</p>
									<p class="s_j">This study offers insight into how individuals round the world make their business choices in foreign languages. People who habitually build choices in a foreign language most probably are not likely at risk of having biased decisions about personal finances.</p>
