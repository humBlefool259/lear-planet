...
<title>MyLearningPlanet | Learning Material for Children | Science Learning materials</title>
<meta name="description" content="MyLearningPlanet is not only tuition center in gurgaon but also providing learning materials for children all subjects. call us today @0124-438-2633 .">
<meta name="Keywords" content="learning material for kids, learning material for children in gurgaon, kids educational games, science learning materials for children in gurgaon">
...
<p class="mail">
        ...
        <div id="main">
            ...
            <div class="breadcrumb-section">
            	<div class="container">
                	<h1>Learning Material for Children</h1>
                    <div class="breadcrumb">
                        <a href="index.php">Home</a>
                        <span class="fa fa-angle-double-right"></span>
                        <a href="#">Services</a>
                        <span class="fa fa-angle-double-right"></span>
                        <span class="current">Learning Material  </span>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
            	...
            	<section id="primary" class="content-full-width">
                            ...
                            <div class="dt-sc-pr-tb-col mustard">	
                                <div class="dt-sc-tb-header">
                                    <div class="dt-sc-tb-thumb">
                                        <img src="images/activity1.jpg" width="572" height="263" alt="Learning Material for Children" title="">
                                    </div>
                    ...
                    <div class="column dt-sc-one-half">                  
                        ...
                        <p style="text-align: justify">Just as a carpenter needs the right tools (such as a saw and hammer) and basic skills (such as how to measure and cut wood) to frame a house, students need the right tools (such as notebooks and assignment pads) and basic study skills (such as reading and note-taking skills) to be successful in school.</p>
                        <p style="text-align: justify">The selection of teaching and learning materials is an integral part for school children. Children and students come into contact with a vast array of print, visual and multimedia materials in their daily lives. Their exposure to such materials is mediated by parents and other caregivers. 
We ensure that the teaching and <strong>learning materials</strong> with which children and students are presented, or towards which they are directed, are appropriate to their developmental growth and relevant to the achievement of appropriate learning outcomes.
<p>
				<p style="text-align:justify">In My Learning Planet we help our child’s with notes/ concise study material which comes very handy while revising the chapters/ subjects. 
