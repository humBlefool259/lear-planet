...
<title>What are the advantages & disadvantages of Activity based learning?</title>
<meta name="description" content="My Learning planet is the best tuition centre in gurgaon offering mathematics tuitions as well as Japanese language etc. Call +91 989-988-8185. ">
...
<ul class="nav navbar-nav">
        ...
        <div id="main">
            ...
            <div class="breadcrumb-section">
            	<div class="container">
                	<h1>What are the advantages & disadvantages of Activity based learning?</h1>
                    <div class="breadcrumb">
                        <a href="index.php">Home</a>
                        <span class="fa fa-angle-double-right"></span>
                        <a href="blog.php">Blog</a>
                        <span class="fa fa-angle-double-right"></span>
                        <span class="current">What are the advantages & disadvantages of Activity based learning?</span>
                    </div>
                </div>
            </div>
            	...
            	<section id="primary" class="with-sidebar">
                    ...
                    <article class="blog-entry">
                        <div class="blog-entry-inner">
                            ...
                            <div class="entry-thumb">
                                <a href="#"><img src="images/activity-based-learnings.jpg" alt="activity based learning" title=""></a>
                            </div>		
                            <div class="entry-details">	
                                <div class="entry-title">
                                    <h3>What are the advantages & disadvantages of Activity based learning?</h3>
                                </div>			
                                <!--entry-metadata ends-->	
                                <div class="entry-body">
<p class="s_j">As the name suggest Activity based learning is gaining knowledge by doing activities. In this methodology students rather than attending the classes given by teachers, they use their creative dynamism to guide them through the activity based material. There is strong lobby supporting either learning channel. People who support traditional ways of learning strongly feels that it worked for them, for their parents, similarly it will work well for their child as well. Another section of society feels otherwise and strongly advocates for activity based learning. Let’s see what are the general advantages and disadvantages we have come across:</p>
                                    
                              <p class="s_j">
									<ul>
									<li>Each child has its own speed to grasp things, activity based learning allows kid to learn fundamentals at their own speed.</li>
									<li>Horizon of learning is pretty wise, it facilitates learning in groups, and mutual learning. Also it has a place for self-learning.</li>
									<li>It allows teacher’s to devote time to individual student needs.</li>
									<li>Since its activity based and kid is involved in the process - their participation allows them to pick fundamentals fast.</li>
									<li>There is no concept of unit test etc, Evaluation is inbuilt in the system which makes it quite child friendly.</li>
									<li>On completing the activity, child has a feeling of sense of accomplishment which boosts child’s confidence.</li>
									<li>Games are needless to say create more buzz among children.</li>
									<li>Creative and communicative skills are bound to groom in this way of learning.</li>
									<li>There is feeling of interaction between teacher and the child, it helps in reducing the barrier between the two. </li>
									</ul></p>
									 <p class="s_j">Now let’s look at some disadvantages which is not allowing activity based learning mushroom it to the huge extent.</p>
									 <p class="s_j">
									<ul>
									<li>It’s important to learn facts right. If fundamentals and facts are not known, it doesn’t help in arguments and debates. </li>
									<li>Same goes for learning any foreign language.</li>
									
									</ul></p>
									
									<p class="s_j">There are not many disadvantages however shortcomings are big enough which makes traditional learning and activity based learning system as complementary mechanism, rather than substituting them completely. If judiciously both the techniques are blended and child is taught it can do wonders. </p> 
<p class="s_j">For best tuition in Gurgaon, contact <a href="http://www.mylearningplanet.in">www.mylearningplanet.in</a>. Call us on +91 9899-888185. You can like us on <a href="http://www.facebook.com/Mylearningplanet">www.facebook.com/Mylearningplanet</a>. </p> 									
                            </div>
