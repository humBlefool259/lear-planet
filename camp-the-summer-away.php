...
<title>My Learning Planet - Camp the summer away</title>
...
<ul class="nav navbar-nav">
        ...
        <div id="main">
            ...
            <div class="breadcrumb-section">
            	<div class="container">
                	<h1>Camp the summer away</h1>
                    <div class="breadcrumb">
                        <a href="index.php">Home</a>
                        <span class="fa fa-angle-double-right"></span>
                        <a href="blog.php">Blog</a>
                        <span class="fa fa-angle-double-right"></span>
                        <span class="current">Summer camp</span>
                    </div>
                </div>
            </div>
            	...
            	<section id="primary" class="with-sidebar">
                    ...
                    <article class="blog-entry">
                        <div class="blog-entry-inner">
                            ...
                            <div class="entry-thumb">
                                <img src="images/summer.jpg" alt="spaced" title="">
                            </div>		
                            <div class="entry-details">	
                                <div class="entry-title">
                                    <h3>Camp the summer away</h3>
                                </div>			
                                <!--entry-metadata ends-->	
							 ...
							 <p class="s_j">Learning while frolicking and relaxing can be the most blooming opportunity for the children to exploit their prized vacation in the most rewarding way. Summer camps offer a superb platform that stimulates and augments the innate abilities, putting a tender smile on the beautiful faces of the children. Enrolling in a summer camps means unlimited fun moments that you could not even fancy.</p>
                             <p class="s_j">Unplugged from technology (a much-needed break), kids will stay within the safety net of guidance counselor learning entertaining sports, adventures and creative works in the company of other children of their age. This goes on to revive their mind and enrich their perception. </p>
                             <p class="s_j"><strong>Summer Camps You Can Attend and Enjoy</strong></p>
                             <p class="s_j">The multitude of summer camps are being organized,  and you could choose the best for your child. These camps are the best options to learn, enjoy and treasure amusing moments. The different types of summer camps are:</p>
                             <p class="s_j"><strong>1.</strong> Technology summer camps: mastering computer basics, animation, graphic design etc.</p>
							<p class="s_j"><strong>2.</strong> Academic summer camps: learning additional languages, abacus, spoken English, handwriting etc.</p>
							<p class="s_j"><strong>3.</strong> Sports summer camps:  fascinating sports activities like tennis, swimming, football, carom, rifle shooting, archery etc.</p>
							<p class="s_j"><strong>4.</strong> Adventure summer camps:  activities like trekking, horse riding, fishing, paragliding, etc.</p>  
							<p class="s_j"><strong>5.</strong> Creative summer camps:  music, dancing, cooking, storytelling, plantation, pottery work, art & craft work, drama, painting, drawing, and many more. </p>  
                             <p class="s_j"><strong>Why Attend a Summer Camp</strong></p>
                             <p class="s_j">Camps fill intense positive effects in your child, cultivating and grooming them in the most operative ways. Check out the paybacks of attending summer camps.</p>
                             <p class="s_j"><strong>1.</strong> Physically active: It is a wonderful chance to get involved in assorted activities that keep them physically fit. Swimming, climbing, running, hiking and others enhance their adventurous and vibrant nature.</p>
							<p class="s_j"><strong>2.</strong> Become resilient: The summer camp boosts children and provides a platform to become resilient, enduring obstacles and failures. They get the opportunity to interact and obtain the right guidance to confront difficulties and conquer fear.</p>
							<p class="s_j"><strong>3.</strong> Socializing: Here children share, play, communicate, work together, resolve matters and build team spirit. They develop comprehensive socialization skills.</p>
							<p class="s_j"><strong>4.</strong> A confident child: Encountering new experience and learning a new skill, the child gains confidence. The students get the skills to efficiently plan and execute the given tasks, cultivate interpersonal relationships and discover new facets of themselves.</p>  
							<p class="s_j">Summer camps come as an antidote to the stressful school lives, enriching the child’s experience with fun filled moments. Give your child the golden chance to learn various interesting activities, singing, dancing, playing, laughing and spending cheerful moments.</p>  
							<p class="s_j">Make sure that your child is not left without these wonderful moments!</p>  
