...
<title>My Learning Planet | About us</title>
...
<meta name="description" content="MyLearningPlanet provides best tuition, coaching classes, home tuition, home tutor in Gurgaon, call us @0124-438-2633.">
    ...
    <div class="wrapper">
        <!--header starts-->
         <header>
            <div class="container">
                <div class="logo">
                    <a href="index.php" title="My Learning Planet"><img src="images/my_learning_planet.png" alt="My Learning Planet" width="232" height="71" title="My Learning Planet"></a>
                </div>
                                            	...
                                            	<ul>
                                                	<li class="widget widget_recent_entries">
                                                    	<div class="entry-thumb">
                                                        	<a href="fun-evenings.php"><img src="images/mega_menu_blog_img1.jpg" alt="menu" width="200" height="137" width="200" height="137" title=""></a><a href="fun-evenings.php" class="funt">Fun evenings</a>
                                                        </div>
                                                    ...
                                                    <li class="widget widget_recent_entries">
                                                    	<div class="entry-thumb">
                                                        	<a href="birthday-parties.php"><img src="images/mega_menu_blog_img2.jpg" width="200" height="137" alt="menu" title=""></a><a href="birthday-parties.php"  class="funt">Birthday Parties </a>
                                                        </div>
            	...
            	<section id="primary" class="content-full-width">
                    ...
                    <div class="column dt-sc-one-half first">
                    	<div class="about-slider-wrapper">
                            <ul class="">
                                <li> <img src="images/activity1.jpg" width="572" height="263" alt="activity" title="" > </li>
                    ...
                    <div class="column dt-sc-one-half">                  
                        ...
                        <p style="text-align: justify">My Learning Planet creates a love of learning in an environment of collaboration, tolerance, wonderment, and play. We provide educational resources that promote understanding and compassion.</p>
                         <p style="text-align: justify">We have always found that learning can be enjoyable and satisfying. Our institute’s mission is to provide education that emphasize creativity and the pure enjoyment of learning. The underlying message for our children is that curiosity and exploration lead to delightful learning experiences. We believe that people learn the most (and retain it the longest) when they are actively involved in educational pursuits that are clear, logical, stimulating, and fun.</p>
<p style="text-align: justify">We started our institute @ Gurgaon in Y2010 with the mission of imparting long lasting learning experiences to our very dear children. We are an experienced team of Educators who excel in their respective fields since more than a decade.</p>


                    </div> 
                    <!--dt-sc-one-half ends-->
                   <div class="entry-body"><p style="text-align: justify"> In a child friendly and safe environment, we aim not only to make the Children self sufficient but also at the same time help them to gain new learning experiences through various hands on activities. Using the high-tech infrastructure and one-to-one interactions with the learners, My Learning Planet helps them to reach utilize their maximum potential in an effective manner.</p>
                                      <p style="text-align: justify">We also keep the parents informed about the progress of the child through weekly observation report (checked in their dashboard), E-Mails by the educators and monthly Parent-Teacher interactions. </p>
<p style="text-align:justify">We maintain long term relationship with Learners and their parents and looking forward to have one with you!</p>
                                    </div> 
                    <div class="dt-sc-hr"></div>
                    
                  
                    <h2 class="dt-sc-hr-green-title">Meet Our Founder</h2>
                  <section id="primary" class="content-full-width">
                  ...
                  <div class="dt-sc-portfolio-container">
                        ...
                        <div class="portfolio dt-sc-one-third column first music">
                          <div class="portfolio-thumb"> <img class="item-mask" src="images/portfolio-mask.png" width="371" height="321"  alt="portfolio" title=""> <img src="images/gaurav-pic.jpg" alt="gaurav" width="370" height="320" title="">
                              <div class="image-overlay"> <a href="gaurav_mehrotra_detail.php" class="link"><span class="fa fa-link"></span></a> <a href="images/gaurav-pic.jpg" title="Gaurav Mehrotra" data-gal="prettyPhoto[gallery]" class="zoom"><span class="fa fa-search"></span></a> </div>
                          </div>
                          <div class="portfolio-detail">
                                <div class="portfolio-title">
                                    <h5><a href="gaurav_mehrotra_detail.php">Gaurav Mehrotra</a></h5>
                                    <p>Founder</p>
                                </div>
                          </div>
                    </div>
                        ...
                        <div class="portfolio dt-sc-one-third column all music">
                            <div class="portfolio-thumb">
                            	<img class="item-mask" src="images/portfolio-mask.png" width="371" height="321" alt="portfolio" title="">
                                <img src="images/mitali.jpg" width="370" height="320" alt="mitali" title="">
                                <div class="image-overlay">
                                    <a href="mitali_mehrotra_detail.php" class="link"><span class="fa fa-link"></span></a>
                                    <a href="images/mitali.jpg" title="Mitali Mehrotra " data-gal="prettyPhoto[gallery]" class="zoom"><span class="fa fa-search"></span></a>
                                </div>
                            </div>
                            <div class="portfolio-detail">
                                <div class="portfolio-title">
                                    <h5><a href="mitali_mehrotra_detail.php"> Mitali Mehrotra </a></h5>
                                    <p>Educator</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="portfolio dt-sc-one-third column all arts fun listen">
                            <div class="portfolio-thumb">
                            	<img class="item-mask" src="images/portfolio-mask.png" width="371" height="321" alt="portfolio" title="">
                                <img src="images/smiriti.jpg" width="370" height="320" alt="smiriti" title="">
                                <div class="image-overlay">
                                    <a href="samrti_sharma_detail.php" class="link"><span class="fa fa-link"></span></a>
                                    <a href="images/smiriti.jpg" title="Samrti Sharma" data-gal="prettyPhoto[gallery]" class="zoom"><span class="fa fa-search"></span></a>
                                </div>
                            </div>
                            <div class="portfolio-detail">
                                <div class="portfolio-title">
                                    <h5><a href="samrti_sharma_detail.php">Samriti Sharma</a></h5>
                                    <p>Educator</p>
                                </div>
                            </div>
                        </div>
