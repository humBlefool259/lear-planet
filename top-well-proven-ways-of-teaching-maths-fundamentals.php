...
<title>My Learning Planet | Blog - Top well proven ways of Teaching Math’s fundamentals</title>
<meta name="description" content="MyLearningPlanet is a best tuition center in gurgaon provide all kinds of tuitions like mathematics tuitions, Japanese language etc. Call us @0124-438-2633.">
...
<ul class="nav navbar-nav">
        ...
        <div id="main">
            ...
            <div class="breadcrumb-section">
            	<div class="container">
                	<h1>Top well proven ways of Teaching Math’s fundamentals</h1>
                    <div class="breadcrumb">
                        <a href="index.php">Home</a>
                        <span class="fa fa-angle-double-right"></span>
                        <a href="blog.php">Blog</a>
                        <span class="fa fa-angle-double-right"></span>
                        <span class="current">Top well proven ways of Teaching Math’s fundamentals</span>
                    </div>
                </div>
            </div>
            	...
            	<section id="primary" class="with-sidebar">
                    ...
                    <article class="blog-entry">
                        <div class="blog-entry-inner">
                            ...
                            <div class="entry-thumb">
                                <img src="images/top-well-proven-ways-of-teaching-maths-fundamentals.jpg" alt="maths tutions in gurgaon" title="">
                            </div>		
                            <div class="entry-details">	
                                <div class="entry-title">
                                    <h3>Top well proven ways of Teaching Math’s fundamentals</h3>
                                </div>			
                                <!--entry-metadata ends-->	
                                <div class="entry-body">
									<p class="s_j">As parents and teachers you are aware that for a child to do well in Math’s in higher classes the basics or fundamentals like addition, subtraction, multiplication and division should be clear. Some basic principles which must be adopted while successfully teaching mathematics fundamentals.</p>
                                     <h4>Limited facts should be taught in one go</h4>									
									<p class="s_j">If child is forced to grasp too many facts in one go, they generally goof up the answer.  Instead, we should enable students to think of the answers without having to figure them out. </p>
  <h4>Tutor them step by step</h4>									
									<p class="s_j">It’s important to go in a step by step manner while teaching them math fundamentals. Once the kids have a mastery on set of fundamentals, keep on adding new set of fundamentals in a checklist to learn. Best is to structure it in a manner that facts which kid has already mastered, new questions from it along with few new fundamentals remain part of the learning process at a time.</p>
  <h4>Verbally memorize the principles</h4>
<p class="s_j">Child must be allowed to memorize the facts by practicing the problem and the solution aloud. It enables them to retain the results for longer duration.</p>
<h4>Do keep realistic goals setting for them</h4>
<p class="s_j">Children have different speed to memorize the fundamentals and also to solve the problems. Keep a realistic goal setting for them, it will enable the kids to better the results with every test and passing time.</p>
<h4>Practice and routine makes the man perfect</h4> 
<p class="s_j">A standard daily/ weekly routine is essential in order to achieve the goal, practice is the key. If routine is set and thorough practice is done, there is absolutely no reason why kid will have weak fundamentals.</p>
<h4>Regular corrective feedback takes the learning to the whole new level</h4>
<p class="s_j">It’s Ok if kid give wrong answers in the first initial attempts, however its utmost important that there must be corrective feedback mechanism is in place and while attempting delayed test, kid comes up with flying colors based on the feedback and subsequent learnings.</p>
<h4>Keep small learning sessions</h4>
<p class="s_j">In tender age, it’s tough for kids to maintain focus for longer duration. Keep frequent learning sessions in the day however try to keep the short sessions for effective learning.</p>
<h4>Progress chart</h4>
<p class="s_j">Keep a tab on the progress of child learning curve. If it’s monitored well, it will let you know if there is dip in any topic. Quick remedial solution will help in keeping the progress chart go north only.</p>
<p class="s_j">We at My Learning Planet strongly believe that basic fundamentals in Mathematics should be good and encourage all children to have the same feeling.  We always are on a look out ways to celebrate children success so as to exhibit the importance of learning math facts.</p>
