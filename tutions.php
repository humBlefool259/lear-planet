...
<title>MyLearningPlanet | Tuition Center in Gurgaon Sector 52 | Tuition  in Gurgaon Ardee City</title>
<meta name="description" content="Mylearningplanet is a tuition center in gurgaon sector 52, best home tuition in gurgaon ardee city for children? for best tuition and tutor in Gurgaon call @0124-438-2633.">
<meta name="Keywords" content="tuitions in gurgaon,  tuition center in gurgaon,  tuition in gurgaon sector 52, science tuition classes in gurgaon, best tuition center in gurgaon, tuition  in gurgaon ardee city">
...
<p class="mail">
        ...
        <div id="main">
            ...
            <div class="breadcrumb-section">
            	<div class="container">
                	<h1>Tuition in Gurgaon for Children</h1>
                    <div class="breadcrumb">
                        <a href="index.php">Home</a>
                        <span class="fa fa-angle-double-right"></span>
                        <a href="#">Services</a>
                        <span class="fa fa-angle-double-right"></span>
                        <span class="current">Tuitions - Classes I to VIII - All subjects</span>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
            	...
            	<section id="primary" class="content-full-width">
                            ...
                            <div class="dt-sc-pr-tb-col mustard">	
                                <div class="dt-sc-tb-header">
                                    <div class="dt-sc-tb-thumb">
                                        <img src="images/activity1.jpg" width="572" height="263" alt="pricing details" title="">
                                    </div>
                    ...
                    <div class="column dt-sc-one-half">                  
                        ...
                        <p style="text-align: justify">We provide flexible and individual out of school tutoring and tuition in gurgaon for all subjects suitable for children from early years till VIII standard. </p>
                        <p style="text-align: justify">Our inspiring and highly experienced tutors provide students with carefully designed educational program, put together specifically to meet their individual needs. The children concentrate on coming to grips with, or extending their skills in topics that they are covering at school - whilst also working on a parallel course constructed to boost their individual core skills.</p>
<p style="text-align: justify">Whilst at a My Learning Planet, children receive tuition from a mentor chosen specifically to work with them. The workshops comprise a mixture of written work and hands-on resources/learning activities (some even call them games!) which help the children learn through a multi-sensory approach.</p>
 <p style="text-align: justify">With so much focus on the individual student, we offer a great alternative to private tuition and are also excellent for children with special needs.<p>
						<p style="text-align: justify">Be it early year’s education, primary school support or <a href="http://www.mylearningplanet.in/special-assistance-in-project-work.php">help with secondary school work</a>, our unique approach offers fun and stimulating learning in a friendly and inclusive environment, will allow your child to fulfill their potential whilst enriching their mind.</p>
				
						</div> 
<span class="dt-sc-hr-green-title"></span>
			
			<div class="column dt-sc-one-half first">
                        <div class="dt-sc-titled-box">
                            <h4 class="dt-sc-titled-box-title">Subject Teaching</h4>
                            <div class="dt-sc-titled-box-content">
                              <p style="text-align: justify">We provide individual and group after school tutoring for all the subjects suitable for children from early years till VIII TH standard. </p>
	<p style="text-align: justify">Our inspiring and highly experienced tutors provide students with carefully designed educational programs put together specifically to meet their individual needs.</p>
	<p style="text-align: justify">The learner concentrate on coming to grip with or extending their skills in topics that they are covering at school whilst also working on a parallel course constructed to boost up their individual core skills.</p>
	</br></br>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="column dt-sc-one-half">
                        <div class="dt-sc-titled-box green">
                            <h4 class="dt-sc-titled-box-title">Topic Teaching </h4>
                            <div class="dt-sc-titled-box-content">
                                <p style="text-align: justify">We know that every child is different and performs differently. The child differs in their learning behavior and grasping power. Sometimes the student is afraid of one subject or topic. In order to help such students we also offer the facility of topic or subject tutoring. With the help of creative worksheets specially designed for specific topic we aim at boosting the confidence level of the child in that particular topic or subject we help them in imparting the knowledge and increasing the interest level of the child in that subject through lot of practice that gives an opportunity to the students to improve upon their weakest area. We concentrate on the positive aspect of the personality of the child and thus use it to improve the weaker areas. We help the learner to discover the most efficient way of learning so that they are able to excel in their studies and career in life.</p>
