            ...
            <div class="breadcrumb-section">
            	<div class="container">
                    ...
                    <div class="breadcrumb">
                        ...
                        <span class="fa fa-angle-double-right"></span>
                        <span class="current">Samrti Sharma</span>
                    </div>
                </div>
            </div>
            	...
            	<section id="primary" class="content-full-width">
                    ...
                    <div class="column dt-sc-one-half first">
                    	<div class="about-slider-wrapper">
                            <ul class="">
                                <li> <img title="" alt="" src="images/smiriti.jpg" style="border:6px solid #ccc;"> </li>
                    ...
                    <h3>Samriti Sharma  <span>Educator</span> </h3>                  
                    
                        <p> A passionate and friendly educator of My Learning Planet, Samriti Sharma did her B.Com and B.Ed. She is an energetic educator who passes her energy to her children by teaching them in a playful manner. In all her lessons, children  participates actively and take a new long lasting learning with them. She did her M.Ed and spent a good amount of time in gaining highly efficient teaching skills.  She loves to guide children in all the tasks which helps them to become self independent.  </p>
                        <p>Her students performance till date is a strong evidence of her love and affection towards her learners. She goes to the level of the children to make the lessons involving and interesting. She believes in maintaining a cordial reputation with her students by being friendly yet firm with them at the same time.  Her expertise and skills attracts her students to be regular and helps in achieving great results year after year. </p>
                      
                        <div class="project-details">
                              
                                <p><span class="fa fa-gift"></span> Qualifications <a href="#">– B.Com, B.Ed, M.Ed</a></p>
                                <p><ul class="prosocial">
                        	<li ><a href=" https://www.facebook.com/samriti.sharma.142?fref=ts" target="_blank"><img title="" alt="" src="images/fd.png"></a></li>
                          
                            <li ><a href="mailto:samriti@mylearningplanet.in"><img title="" alt="" src="images/mailto.png"></a></li>
