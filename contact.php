...
<?php
     ...
     $send_mail = mail($to,$email,$msg,$header) or die("Failure!");
     if($send_mail)
     {
		 $messg = 'Successfully Sent!!';
...
<title>Contact Us - My Learning Planet</title>
...
<p class="mail">
                    ...
                    <nav id="main-menu">
                        ...
                        <ul id="menu-main-menu" class="menu">
                           ...
                           <li class="menu-item-megamenu-parent megamenu-4-columns-group menu-item-depth-0 steelblue"> <a href="#" title=""> Services </a> 
                                            	...
                                            	<ul>
                                                	<li class="widget widget_recent_entries">
                                                    	<div class="entry-thumb">
                                                        	<a href="fun-evenings.php"><img src="images/mega_menu_blog_img1.jpg" alt="mega_menu" title=""></a><a href="fun-evenings.php" class="funt">Fun evenings</a>
                                                        </div>
                                                    ...
                                                    <li class="widget widget_recent_entries">
                                                    	<div class="entry-thumb">
                                                        	<a href="birthday-parties.php"><img src="images/mega_menu_blog_img2.jpg" alt="mega_menu" title=""></a><a href="birthday-parties.php"  class="funt">Birthday Parties </a>
                                                        </div>
                            ...
                            <li class="pink current_page_item"><a href="contact.php" title="" class="bol">Contact us</a></li>
        ...
        <div id="main">
            ...
            <div class="container">
				...
				<div id="divv1">
				<p id="p1" class="p_tb">
				<b>Use our contact form for general questions about classes, fees, curriculum, birthday parties, comment, compliment or complaint or anything else you can’t find on our website. A member of our staff will contact you within one business day. Thank you.</b>
				</p>
				</div></br>
				
					<iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d14033.335783475552!2d77.079358!3d28.439348!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x41a78a9d749ae380!2sWebfries!5e0!3m2!1sen!2sin!4v1418288873174" width="1200" height="450" frameborder="0" style="border:0"></iframe>
                    ...
                    <div class="column dt-sc-one-fourth class_hours">
                    	<h2>Class Hours</h2>
                        <ul class="class_hours">
                        	<li>Monday<span>3pm - 9pm</span></li>
                            <li>Tuesday<span>3pm - 9pm</span></li>
                            <li>Wednesday<span>3pm - 9pm</span></li>
                            <li>Thursday<span>3pm - 9pm</span></li>
                            <li>Friday<span>3pm - 9pm</span></li>
                            <li>Saturday<span>11am - 7pm</span></li>
                            <li>Sunday<span>11am - 7pm</span></li>
                        </ul>
                        <div class="dt-sc-hr-small"></div>
                        <p><strong><span class="highlighter">We care</span> about your dearest Kids!</strong></p>
                        <ul class="dt-sc-social-icons">
                        	<li class="facebook"><a href="https://www.facebook.com/Mylearningplanet" title="Facebook" class="dt-sc-tooltip-bottom" target="blank"><img src="images/facebook.png" alt="facebook" title=""></a></li>
                            <li class="twitter"><a href="https://twitter.com/Mylearningplane" title="Twitter" class="dt-sc-tooltip-bottom"><img src="images/twitter.png" alt="twitter" title="" target="blank"></a></li>
                            <li class="gplus"><a href="https://plus.google.com/u/0/b/118178787253037045021/dashboard/overview" title="Google Plus" class="dt-sc-tooltip-bottom"><img src="images/gplus.png" alt="gplus" title="" target="blank"></a></li>
                            <li class="pinterest"><a href="http://www.pinterest.com/mylearningplane" title="Pinterest" class="dt-sc-tooltip-bottom"><img src="images/pinterest.png" alt="pinterest" title="" target="blank"></a></li>
							<li class="twitter"><a href="https://www.linkedin.com/company/my-learning-planet" title="Linkedin" class="dt-sc-tooltip-bottom"><img src="images/link1.png" alt="link1" title="" target="blank"></a></li>
                        </ul>
                    </div>
