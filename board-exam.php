...
<ul class="nav navbar-nav">
        ...
        <div id="main">
            ...
            <div class="breadcrumb-section">
            	<div class="container">
                	<h1>Board Exams 2015</h1>
                    <div class="breadcrumb">
                        <a href="index.php">Home</a>
                        <span class="fa fa-angle-double-right"></span>
                        <a href="blog.php">Blog</a>
                        <span class="fa fa-angle-double-right"></span>
                        <span class="current">Board Exams- Exams for students or for parents</span>
                    </div>
                </div>
            </div>
            	...
            	<section id="primary" class="with-sidebar">
                    ...
                    <article class="blog-entry">
                        <div class="blog-entry-inner">
                            ...
                            <div class="entry-thumb">
                                <a href="#"><img src="images/blog12.jpg" alt="blog" title=""></a>
                            </div>		
                            <div class="entry-details">	
                                <div class="entry-title">
                                    <h3>Board Exam 2015</h3>
                                </div>			
                                <!--entry-metadata ends-->	
                                <div class="entry-body">
<p class="s_j">This year around 25 lakh students are appearing for Board Exams (CBSE and ICSE - combined for Class X and Class XII both).</p>
                                    
                                    <p class="s_j">This year Board exams have increased the level of anxiety not only for students but also for their parents. It seems like board exams is for their parents as well, since they spend lot of day’s routine helping their child to prepare for the exam. </p>
                                    <p class="s_j">Many parents have taken the burden of their ward’s examination on themselves. This creates unnecessary pressure on both child and parent.</p>
                                    <p class="s_j">This year there are lots of distraction for students with World cup currently been held and India winning all the matches. Parents are keeping a strict eye that their child don’t get glued to T.V. to watch World Cup. With current  outbreak of H1N1 parents are cautious about eating habit of their child. And like every year this time also HOLI will be celebrated in the clouds of Board Exams.</p>
                                    <p class="s_j">Parents should not impose useless restrictions, they play very important role in boosting confidence of  their children. Under pressure kids body stops generating important hormones which is not good for health and can hamper their concentration level. </p>
                                    <p class="s_j">So, parents should be relaxed themselves and should make it a point that their child is also relaxed.</p>
                                </div>	 		
                            </div>	
                        </div>
                    </article>
                        ...
                        <ul class="commentlist">
                        	<li>
                            	<article class="comment">
                                	<header class="comment-author">
                                        ...
                                        <img src="images/comment1.jpg" alt="comment" title="">
                                    </header>
                                ...
                                <ul class="children">
                                	<li>
                                    	<article class="comment">
                                            <header class="comment-author">
                                                <img class="item-mask" src="images/author-hexa-bg.png" alt="author" title="">
                                        		<img src="images/comment2.jpg" alt="comment" title="">
                                            </header>
                                            <section class="comment-details">	
                                                <div class="author-name">
                            ...
                            <li>
                            	<article class="comment">
                                	<header class="comment-author">
                                    	<img class="item-mask" src="images/author-hexa-bg.png" alt="author" title="">
                                        <img src="images/comment3.jpg" alt="comment" title="">
                                    </header>
                                    <section class="comment-details">	
                                        <div class="author-name">
