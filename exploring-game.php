                                            	...
                                            	<ul>
                                                	<li class="widget widget_recent_entries">
                                                    	<div class="entry-thumb">
                                                        	<a href="fun-evenings.php"><img src="images/mega_menu_blog_img1.jpg" alt="images" title=""></a><a href="fun-evenings.php" class="funt">Fun evenings</a>
                                                        </div>
                                                    ...
                                                    <li class="widget widget_recent_entries">
                                                    	<div class="entry-thumb">
                                                        	<a href="birthday-parties.php"><img src="images/mega_menu_blog_img2.jpg" alt="images" title=""></a><a href="birthday-parties.php"  class="funt">Birthday Parties </a>
                                                        </div>
...
<ul class="nav navbar-nav">
        ...
        <div id="main">
            ...
            <div class="breadcrumb-section">
            	<div class="container">
                	<h1>Exploring Game Based Learning</h1>
                    <div class="breadcrumb">
                        <a href="index.php">Home</a>
                        <span class="fa fa-angle-double-right"></span>
                        <a href="blog.php">Blog</a>
                        <span class="fa fa-angle-double-right"></span>
                        <span class="current">Exploring Game Based Learning</span>
                    </div>
                </div>
            </div>
                    ...
                    <article class="blog-entry">
                        <div class="blog-entry-inner">
                            <div class="entry-meta">
                                <a href="#" class="blog-author"><img src="images/rounded-bg-img.jpg" alt="images" title=""></a>
                                <div class="date">
                                            <span> 20 </span> 
                                            <p> March <br> 2015 </p> 
                                        </div>
                            ...
                            <div class="entry-thumb">
                                <a href="#"><img src="images/jack2.jpg" alt="images" title=""></a>
                            </div>		
                            <div class="entry-details">	
                                <div class="entry-title">
                                    <h3>Exploring Game Based Learning</h3>
                                </div>			
                                <!--entry-metadata ends-->	
                                <div class="entry-body">
<p class="s_j"><em>“All work and No play makes Jack a dull boy”</em></p>
                                    
                                    <p class="s_j">We have been using this idiom since long, but it could not have been the best time other than recent years to actually proof this to be true. Games have found their way into the curriculum of most of the schools that believe in making learning a fun.</p>
                                    <p class="s_j">Forty years of research has established that games are effective learning tools. Kids learn from games…and they will learn MORE from a game than from any other form of learning. They might just be one of our paramount tool in delivering an effective education.  However, <strong>it doesn’t get well with most of the people that WHY games work?</strong> For them, games are frivolous.</p>
                                    <p><strong>How Game-Based Learning Works</strong></p>
                                    <p class="s_j">It’s logical if there’s a some amount of a cognitive disagreement here. We need to understand how the fun of games relates to the basics of effective learning strategy. After all, Games are for fun, and fun tends to be something kids prefer to do instead of learning.</p>
                                    <p class="s_j">An interesting point is made here by Jessica Trybus of the New Media Institute. “Deconstruct the fun in any good game,” she says, “and it becomes clear that what makes it enjoyable is the built-in learning process.”</p>
                                    <p class="s_j">A well-designed gaming experience can be related closely to a well-designed curriculum. Most games, educational or otherwise, start with the basic skills, then a few low-intensity challenges are introduced, steady increase in difficulty follows while conveying new techniques and providing pass/fail progress exams (or “boss levels,” !!!).</p>
                   
                   <p>Let’s see what are the elements of the Game-based learning that make it click.</p>  
                   <ul>
                   <li>Winning! We all like to win !!!  Though it is not always about competition. Games can be cooperative or competitive. Cooperation can also lead to a “win” if you beat the game itself by achieving the game goal. Winning or Triumphing could mean mastering something really, really hard.</li>
                    <li>Collaborating. Think of times you’ve played a game as a team – and the delight you got out of achieving together as a team. We surely relish the opportunity to work with others.</li>
                     <li>Collecting. Human Psychology suggests that collecting is fun. Ever play Pac Man?  Lots of card games allow you to collect cards (Rummy, Canasta). The game-based learning includes ‘collecting games’ and kids actually ‘collect’ many new skills and techniques hidden within those games</li>
                      <li>Problem-solving or strategizing. Word searches, Crossword puzzles and strategy games (likes of Civilization and Age of Empires) are a hit because we like to solve problems and  like to formulate strategies that can help us build things, achieve, collect, triumph, etc. The skill of problem-solving stays with the kids for life</li>
                       <li>Role-playing. Playing someone or something you’re not in the reality is fun for many people. It gives a chance to identify with something you aspire. At the same time, it is also a very safe way to try on new behaviors.</li>
                        <li>Surprise.  We enjoy the element of surprise. In fact, often the biggest fun is in giving the surprise, not receiving the surprise. Games thrive on this element.</li>
                                          
                   </ul>   <p>The academic studies in the education,  child psychology and computer science have shown that the learning results for engaged, motivated students far exceed those of students subjected to traditional memorization and recall programs. Students having exposure to game-based learning showed deeper engagement with the material.</p>
                   <p>Though the surveys and researchers also suggested that many teachers may not have had the opportunity to expose their classrooms to the full range of game-based learning. They have a dearth of suitable access to the technology needed to effectively include interactive digital media into their curriculum.</p>
                   <p><strong>Potential Shortcomings</strong></p> 
                   <p>Everything comes with a string attached. Some studies have showed that students may become distracted by competitive elements in games and thus missing out on the potential for deep learning.  They focus may shift to the desire to win by whatever means available. It is suggested that learning games collaborative nature or having focus on individual skill-based can evade being hijacked by students’ competitive spirit.</p>
                   <p>In a study, it was found that the game-based learning and traditional learning produced different results for different scenarios. While the game-based students showed greater motivation and got higher marks in practical challenges, their traditionally educated counterparts participated more readily in class and performed better on written assignments.</p>
                   <p><strong>Last Words</strong></p>
                   <p>Game-based learning may not be a panacea for schools wishing to pump up student performance, but some things just don’t have quick fixes. Game-enhanced curriculum has been shown to have effects both grand and subtle on the attitudes and outcomes of learning. Teachers could do well to further explore and experiment with the right kind of mix to enhance the overall learning experience and at the same time making sure that students perform well in the traditional system of examination.</p>       </div>	 		
                            </div>	
                        </div>
                    </article>
                        ...
                        <ul class="commentlist">
                        	<li>
                            	<article class="comment">
                                	<header class="comment-author">
                                        <img class="item-mask" src="images/author-hexa-bg.png" alt="images" title="">
                                        <img src="images/comment1.jpg" alt="images" title="">
                                    </header>
                                ...
                                <ul class="children">
                                	<li>
                                    	<article class="comment">
                                            <header class="comment-author">
                                                <img class="item-mask" src="images/author-hexa-bg.png" alt="images" title="">
                                        		<img src="images/comment2.jpg" alt="images" title="">
                                            </header>
                                            <section class="comment-details">	
                                                <div class="author-name">
                            ...
                            <li>
                            	<article class="comment">
                                	<header class="comment-author">
                                    	<img class="item-mask" src="images/author-hexa-bg.png" alt="images" title="">
                                        <img src="images/comment3.jpg" alt="images" title="">
                                    </header>
                                    <section class="comment-details">	
                                        <div class="author-name">
