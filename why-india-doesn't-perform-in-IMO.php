...
<ul class="nav navbar-nav">
        ...
        <div id="main">
            ...
            <div class="breadcrumb-section">
            	<div class="container">
                	<h1>What makes Math so boring ?</h1>
                    <div class="breadcrumb">
                        <a href="index.php">Home</a>
                        <span class="fa fa-angle-double-right"></span>
                        <a href="blog.php">Blog</a>
                        <span class="fa fa-angle-double-right"></span>
                        <span class="current">Why India doesn't perform in IMO?</span>
                    </div>
                </div>
            </div>
            	...
            	<section id="primary" class="with-sidebar">
                    ...
                    <article class="blog-entry">
                        <div class="blog-entry-inner">
                            ...
                            <div class="entry-thumb">
                                <a href="#"><img src="images/imo.jpg" alt="maths" title=""></a>
                            </div>		
                            <div class="entry-details">	
                                <div class="entry-title">
                                    <h3>Why India doesn't perform in IMO?</h3>
                                </div>			
                                <!--entry-metadata ends-->	
                                <div class="entry-body">
<p class="s_j">Zero diya mere Bharat ne to duniya ko ginti aayi</p>
                                    
                                    <p class="s_j">We Indians have been humming this song from Manoj Kumar’s movie for at least last two generations and take pride in mathematical feats achieved by our great great great forefathers, like invention of zero, decimal, trigonometry etc., thousands of years ago. But in fact what we are indulging in, is the self-conceit very well explained by a Persian idiom</p>
									<strong>“My father was a King”</strong></br>
									<p class="s_j">Thus, while we take pride in basking in the glory of the achievements our civilization accomplished thousands of years ago, the current generations of Indians are no way nearer to the top scorers at the International Mathematics Olympiad, the de facto world platform of mathematical prowess of nations.</p>
									<p class="s_j">What could be the reason of the consistent below par show of the Indian prodigies at IMO, when Indian kids start mathematics pretty early in the school as compared to many other countries and our school curriculum is also considered to be much tough.</p>
									<p class="s_j"><strong>Education System</strong></p>
									<p class="s_j">Given its large population, tedious school curriculum and mathematical traditions from ancient times , India is expected to do much better at the IMO. Of course, if we could recognize the top-most mathematically talents in the country, India would unquestionably be among the top scoring countries. Being completely forthright: the education system of India and especially the way maths is taught, makes the mathematically unskilled guys think they're pretty good. In general, with few exceptions, most of the school toppers are actually over-rated. Our examination system for best part of the schooling actually tests our memorizing. You never get any stimulating problems in the exams. You only have trivial "differentiate this polynomial" and "find sin (60°) + sin(30°)*sin(45°)" sort of problems. What's even more absurd is that you are expected to add a line of "explanation" beside each step to get full marks. Thus, most of students who score 100 at school exams are not mathematical geniuses but kids who are good at learning by rote. </p>
									<p class="s_j">And even more ridiculous is that, this all misleads other students, who might have done very well at mathematical Olympiads, into thinking that mathematics is not their cup of tea</p>
									<p class="s_j"><strong>Awareness</strong></p>
									<p class="s_j">The awareness of the Olympiad program, at least at school level  is disappointingly low in India. Not many parents as well as students are much aware about such a platform. Even the schools, barring a few in metro cities, are not helping the cause either. </p>
 <p class="s_j">Of course, not everyone is good at mathematics and not everyone should be aiming for the IMO. But the countries that are doing well at IMO are essentially good at sorting out the mathematically talented students. What's worse is that students who have thinking abilities and might have the stamina and patience to work on a problem for hours at a stretch before succeeding, are disheartened by their low marks in time constrained school exams. They are devastatingly fooled into thinking that they are incompetent as far as mathematics is concerned. In any other country, these students would most certainly have heard of the maths Olympiads and may have very well made it to the IMO. But India is precariously destroying these possibly talented students and instead give a round of applause to a bunch of idiots who are without any problem solving skills and take to feet when faced with a problem which they are unclear about how to approach.</p> 
 <p class="s_j"><strong>Incompetent Special Maths Exams</strong></p>
  <p class="s_j">If take example of theUS,  apart from  AMC, AIME, and USAMO which are more or less mainstream exams that lead to IMO, there are a great deal of other fun maths contests  which establish that maths isn't all about good grades. There are also many maths camps. In India, the RMO and INMO as well as the SOF-IMO are again no better than school examinations. The SOF-IMO just comprises of a few standard MCQ questions similar to those you have in school exams (Mr. Gupta loans Rs. 100000 at 5% simple interest from X bank. How much will he return 10 years later?), a sitting duck indeed. Thus these exams serve no purpose to identify the most mathematically talented students.</p>
   <p class="s_j"><strong>‘IIT is the best’ Syndrome</strong></p>
     <p class="s_j">And then there's IIT. </p>
	  <p class="s_j">The mindset of a normal middle class parent is: "IIT is the ultimate goal of all Science Stream students and my kid will score 95% + and go to IIT, nothing less. Even the entrance process for IIT is not much conducive to real understanding of concepts and problem solving skills. After reserving seats for socially backward classes, the rest of the future of rest of the ‘talents’ is sealed through speed test (JEE) </p>
	   <p class="s_j">Thus, the IIT coaching classes, that almost every eleventh grade students are forced to joinare teaching students to nothing more than how to think fast and do mental calculations quickly. None of these qualities are required for Olympiad mathematics and students who are serious about Maths Olympiad are once again discouraged and forced to waste their time at these classes.</p>
	    <p class="s_j">Again, all you of you would have startled at calling IIT-JEE preparation classes, a waste of time because it is imbedded deep in our minds that there is no life beyond IIT and it is the only golden gate to perpetual success. </p>
	  <p class="s_j">In summary, we could say that unless India is able to get itself rid of the IIT craze, realizes that the school toppers are mostly good photocopy machines (thanks to our education system) , and lets the students who want to chase olympiad  dream, concentrate on their goals, it is highly doubtful that India will perform any better at the upcoming IMOs. </p>
	  <p class="s_j">If you are thinking, why so much fuss about IMO, then the article was not for you.</p>
