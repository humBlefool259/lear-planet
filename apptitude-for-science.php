            	...
            	<section id="primary" class="with-sidebar">
                    ...
                    <article class="blog-entry">
                        <div class="blog-entry-inner">
                            ...
                            <div class="entry-thumb">
                                <a href="#"><img src="images/appti.jpg" alt="appti" title=""></a>
                            </div>		
                            <div class="entry-details">	
                                <div class="entry-title">
                                    <h3>Apptitude for Science</h3>
                                </div>			
                                <!--entry-metadata ends-->	
                                <div class="entry-body">
<p class="s_j">Apps are everywhere these days and you have an app for almost everything. So why not an app for teaching the most dry subject, science. This makes all the more sense when mobile phones and tabs have found their way into the hands of kids. Thus, making them learn while they have fun is the real motive behind the apps that have decided to make science simpler for the kids and the teachers alike.</p>
                                    
                                    <p class="s_j">We bring to you a few apps that come handy to teach and learn the concepts of science.</p>
							...
							<p><img src="images/3d.jpg" width="445" height="272" alt="best tuition center in gurgaon" title=""></p>
							...
							<p><img src="images/night.jpg" width="445" height="272" alt="best tuition center in gurgaon" title=""></p>
								<p class="s_j">You will no longer be at loss, gazing at the night sky and wondering what all stars and constellations are there. The Night Sky will serve you as a guide for the celestial bodies. It also contains stargazing weather reports and pollution maps. Rs. 90, available for iOS and Android.</p>
							</div>
							<div class="column dt-sc-one-half first" >
                                <h4>Monster Physics</h4>
                            
							<p><img src="images/physics.jpg" width="445" height="272" alt="best tuition center in gurgaon" title=""></p>
								<p class="s_j">Aimed at a younger audience, Monster Physics is a colorful app that lets the kid build machines like rockets, tanks, cars and helicopters, using wood, rubber, plastic, and ice -- and of course physics. Rs.120, available for iOS.</p>
							</div>
							<div class="column dt-sc-one-half">
                                <h4>Periodic Table</h4>
                          
							<p><img src="images/peri.jpg" width="445" height="272" alt="best tuition center in gurgaon" title=""></p>
								<p class="s_j">Periodic Table is one of the most ghastly thing that gives kids nightmares.  Turn the nightmares into sweet dreams of success and make them have 118 elements at the tips of their fingers. Try Periodic Table. This app has all 118 elements, with electron shell diagrams for each one and information on various properties. And if you like more details, an in-app purchase will let you have a solubility chart too. Free, available for Android.</p>
							</div>
							<div class="column dt-sc-one-half first" >
                                <h4>Chemical Equation Balancer</h4>
                            
							<p><img src="images/chem.jpg" width="445" height="272" alt="best tuition center in gurgaon" title=""></p>
								<p class="s_j">This app will make you envy as you would marvel at how much stress-free high school would have been had you had an app that balanced chemical equations for you. Free, available for Android.</p>
							</div>
							<div class="column dt-sc-one-half">
                                <h4>Gravity Lab</h4>
                          
							<p><img src="images/gravity.jpg" width="445" height="272" alt="best tuition center in gurgaon" title=""></p>
								<p class="s_j">Create your own universe by creating particles, and playing around with mass and velocity. This app will help your kids to learn about how laws of physics influences the physical relationships between the particles. Rs. 60, available for iOS.</p>
							</div>
							<div class="column dt-sc-one-half first" >
                                <h4>Frog Dissection</h4>
                            
							<p><img src="images/frog.jpg" width="445" height="272" alt="best tuition center in gurgaon" title=""></p>
								<p class="s_j">Biology classes at school would have been a lot less messy with this app named, Frog Dissection. Poke around the internal mechanisms of a digital frog and study about specific organs, as well as other facts on things like types of frogs and their lifecycles. The one thing this app does not feature is the overpowering smell of formaldehyde. Rs.308, available for iOS and Android.</p>
							</div>
                        </div>
                    </article>
